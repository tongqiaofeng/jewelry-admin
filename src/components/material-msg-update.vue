<template>
  <div>
    <el-dialog
      v-if="dialogMaterialMsgVisible"
      title="材料信息"
      :visible.sync="dialogMaterialMsgVisible"
      ...
      <div id="invenSome">
        <el-tabs style="margin-top: 20px;" v-model="activeStockName">
          <el-tab-pane label="材料信息" name="first">
            ...
            <div class="font-div">
              <div class="div-one">
                ...
                <div class="one-right">
                  <el-input
                    v-model="materialUpdateMsg.materialName"
                    readonly
                  ></el-input>
                </div>
              </div>
              <div class="div-one">
                ...
                <div class="one-right">
                  <el-input
                    v-model="materialUpdateMsg.storageName"
                    readonly
                  ></el-input>
                </div>
              </div>
              ...
              <div class="div-one" v-show="certificateshow2 == false">
                ...
                <div class="one-right">
                  <el-input
                    ...
                    v-model="materialUpdateMsg.boxNumber"
                    clearable
                  >
                  </el-input>
                </div>
              ...
              <div class="div-one" v-show="certificateshow2 == false">
                ...
                <div class="one-right">
                  <el-input
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.shape"
                    clearable
                  >
                  </el-input>
                </div>
              ...
              <div class="div-one" v-show="certificateshow2 == false">
                ...
                <div class="one-right">
                  <el-input
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.size"
                    clearable
                  >
                  </el-input>
                </div>
              ...
              <div class="div-one" v-show="certificateshow2 == false">
                ...
                <div class="one-right">
                  <el-input
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.productArea"
                    clearable
                  >
                  </el-input>
                </div>
              ...
              <div class="div-one" v-show="certificateshow2 == false">
                ...
                <div class="one-right">
                  <el-input
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.color"
                    clearable
                  >
                  </el-input>
                </div>
              ...
              <div class="div-one" v-show="certificateshow2 == false">
                ...
                <div class="one-right">
                  <el-input
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.quality"
                    clearable
                  >
                  </el-input>
                </div>
              ...
              <div class="div-one" v-show="certificateshow2 == false">
                ...
                <div class="one-right">
                  <el-input
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.subsection"
                    clearable
                  >
                  </el-input>
                </div>
              ...
              <div class="div-one" v-show="certificateshow2 == false">
                ...
                <div class="one-right">
                  <el-input
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.paired"
                    clearable
                  >
                  </el-input>
                </div>
              ...
              <div class="div-one" v-show="certificateshow2 == false">
                ...
                <div class="one-right">
                  <el-input
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.certificateNumber"
                    clearable
                  >
                  </el-input>
                </div>
            ...
            <div class="font-div">
              <div class="div-one-note">
                ...
                <div class="one-right">
                  <el-input
                    type="textarea"
                    v-model="materialUpdateMsg.note"
                    :readonly="isUpdate == 0 ? true : false"
                  >
                  </el-input>
                </div>
            ...
            <div class="font-div">
              <div class="div-one" v-show="certificateshow2 == false">
                ...
                <div class="one-right">
                  <el-input
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.billNumber"
                    clearable
                  >
                  </el-input>
                </div>
              ...
              <div class="div-one" v-show="certificateshow2 == false">
                ...
                <div class="one-right">
                  <el-radio-group
                    v-model="materialUpdateMsg.chargeUnit"
                    disabled
                  >
              ...
              <div class="div-one" v-show="certificateshow2 == false">
                ...
                <div class="one-right">
                  <el-input
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.unitPrice"
                    @input="priceTotal"
                    clearable
                  >
                  </el-input>
              ...
              <div class="div-one" v-show="certificateshow2 == false">
                ...
                <div class="one-right">
                  <el-radio-group
                    v-model="materialUpdateMsg.currency"
                  ...
                  <el-input
                    :readonly="
                      isUpdate == 0
                        ...
                        : true
                    "
                    v-model="materialUpdateMsg.number"
                    clearable
                    ><i
                      slot="suffix"
                      v-if="materialUpdateMsg.chargeUnit == '粒'"
                      style="color: #606266;font-style:normal;"
                      >{{ materialUpdateMsg.chargeUnit }}</i
                    >
                  </el-input>
                </div>
              </div>
              <div class="div-one" v-show="certificateshow2 == false">
                ...
                <div class="one-right">
                  <el-input
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.weight"
                    @input="priceTotal"
                    clearable
                    ><i
                      slot="suffix"
                  ...
                  <el-input
                    :readonly="
                      isUpdate == 0
                        ...
                        : true
                    "
                    v-model="materialUpdateMsg.totalPrice"
                    clearable
                  >
                    <i
                      slot="suffix"
              ...
              <div class="div-one" v-show="certificateshow2 == false">
                ...
                <div class="one-right">
                  <el-input
                    :readonly="isUpdate == 0 ? true : false"
                    @input="totalPriceHkRateChange"
                    v-model="materialUpdateMsg.totalHkRate"
                    clearable
                  >
                  </el-input>
                </div>
              ...
              <div class="div-one" v-show="certificateshow2 == false">
                ...
                <div class="one-right">
                  <el-input
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.totalHkPrice"
                    clearable
                  >
                  </el-input>
                </div>
              ...
              <div class="div-one" v-show="certificateshow2 == false">
                ...
                <div class="one-right">
                  <el-input
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.adviceWholesalePrice"
                    clearable
                  >
                  </el-input>
                </div>
              ...
              <div class="div-one" v-show="certificateshow2 == false">
                ...
                <div class="one-right">
                  <el-input
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.adviseSellPrice"
                    clearable
                  >
                  </el-input>
                </div>
              ...
              <div class="div-one" v-show="certificateshow2 == false">
                ...
                <div class="one-right">
                  <el-input
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.lowestSellPrice"
                    clearable
                  >
                  </el-input>
                </div>
              ...
              <div class="div-one" v-show="certificateshow2 == false">
                ...
                <div class="one-right">
                  <el-input
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.agentPrice"
                    clearable
                  >
                  </el-input>
                </div>
              ...
              <div class="div-one" v-show="certificateshow2 == false">
                ...
                <div class="one-right">
                  <el-input
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.counterLowestSellPrice"
                    clearable
                  >
                  </el-input>
                </div>
              ...
              <div class="div-one" v-show="certificateshow2 == false">
                ...
                <div class="one-right">
                  <el-input
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.tagPrice"
                    clearable
                  >
                  </el-input>
                </div>
          ...
          <el-tab-pane
            label="销售信息"
            name="third"
            v-if="materialUpdateMsg.state == 3"
          >
            <div style="display: flex;justify-content: flex-end;">
            ...
            <div class="font-div">
              <div class="div-one">
                ...
                <div class="one-right">
                  <el-input
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.sellBillNumber"
                    clearable
                  >
                  </el-input>
                </div>
              ...
              <div class="div-one">
                ...
                <div class="one-right">
                  <el-input
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.solder"
                    clearable
                  >
                  </el-input>
                </div>
              ...
              <div class="div-one">
                ...
                <div class="one-right">
                  <el-autocomplete
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.group"
              ...
              <div class="div-one">
                ...
                <div class="one-right">
                  <el-input
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.customer"
                    clearable
                  >
                  </el-input>
                </div>
              ...
              <div class="div-one">
                ...
                <div class="one-right">
                  <el-autocomplete
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.customerType"
              ...
              <div class="div-one">
                ...
                <div class="one-right">
                  <el-radio-group
                    ...
                    v-model="materialUpdateMsg.saleCurrency"
                    :disabled="isUpdate == 0 ? true : false"
                  >
                    <el-radio label="CNY">CNY</el-radio>
                    <el-radio label="EUR">EUR</el-radio>
              ...
              <div class="div-one">
                ...
                <div class="one-right">
                  <el-input
                    @input="moneyChange"
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.saleMoney"
                    clearable
                  >
                  </el-input>
                </div>
              ...
              <div class="div-one">
                ...
                <div class="one-right">
                  <el-input
                    ...
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.totalToHkRate"
                    clearable
                  >
                  </el-input>
                </div>
              ...
              <div class="div-one">
                ...
                <div class="one-right">
                  <el-input
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.sellTotalHkPrice"
                    clearable
                  >
                  </el-input>
                </div>
              ...
              <div class="div-one">
                ...
                <div class="one-right">
                  <el-input
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.otherExpenses"
                    clearable
                  >
                  </el-input>
                </div>
              ...
              <div class="div-one">
                ...
                <div class="one-right">
                  <el-input
                    :readonly="isUpdate == 0 ? true : false"
                    v-model="materialUpdateMsg.receiver"
                    clearable
                  >
                  </el-input>
                </div>
              ...
              <div class="div-one-note">
                ...
                <div class="one-right">
                  <el-input
                    type="textarea"
                    v-model="materialUpdateMsg.outNote"
                    :readonly="isUpdate == 0 ? true : false"
                  >
                  </el-input>
                </div>
