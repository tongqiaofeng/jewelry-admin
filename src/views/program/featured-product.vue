  ...
  <div class="activity-admin-container" id="activityAdmin">
    ...
    <div class="add-container">
      <div class="add-left">
        ...
        >
          <el-form-item prop="productIdList" label="主推产品">
            <el-table
              ref="singleTable"
    ...
    addActivitySubmit(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          recommendProductPort(this.addActivityData)
            .then((res) => {
              console.log("活动提交");
              console.log(res);
    ...
    getActivityList() {
      recommendProductListPort()
        .then((res) => {
          console.log("主推产品列表");
          console.log(res);
          this.addActivityData.productIdList = res.data.data;
        })
        .catch((err) => {
          console.log(err);
        });
